...
class GameFieldAlt extends Canvas implements MouseListener
{
	...
	/**
	 * Set the current Game for this GameFieldAlt.
	...
	/**
	 * Get the current Game of this GameFieldAlt.
	...
	{
		this.mouseClickStarted = GameFieldAlt.now();
	...
	{
		long clickTime  = GameFieldAlt.now() - this.mouseClickStarted;
